...
(function (blink) {
    ...
    var aulaenaccion2022demoStyle = function () {
            blink.theme.styles.basic.apply(this, arguments);
        },
        page = blink.currentPage;

    aulaenaccion2022demoStyle.prototype = {
        //BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
        parent: blink.theme.styles.basic.prototype,
        bodyClassName: 'content_type_clase_aulaenaccion2022demo',
        ckEditorStyles: {
            name: 'aulaenaccion2022demo',
            styles: [
                ...
                { name: 'Icono 03', element: 'span', attributes: { 'class': 'icon icon-3' } },
                { name: 'Icono 04', element: 'span', attributes: { 'class': 'icon icon-4' } },
                { name: 'Icono 05', element: 'span', attributes: { 'class': 'icon icon-5' } },
        ...
        formatCarouselindicators: function (scope, classNavbar) {
            var that = scope || this,
                navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'aulaenaccion2022demo-navbar'),
    ...
    aulaenaccion2022demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), aulaenaccion2022demoStyle.prototype);

    blink.theme.styles['aulaenaccion2022demo'] = aulaenaccion2022demoStyle;
